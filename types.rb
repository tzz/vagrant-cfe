...
module Types
  ...
  FRAGMENTS = {
    ...
    :core_checkout_353 => { :install_version => "3.5.3" },
    ...
    :centos_client_enterprise353_rpm => { :install_version => "/vagrant/resources/packages/cfengine-nova-3.5.3-1.x86_64.rpm" },
    :ubuntu_client_enterprise353_deb => { :install_version => "/vagrant/resources/packages/cfengine-nova_3.5.3-1_amd64.deb" },
    ...
    :centos_hub_enterprise353_rpm => { :install_version => "/vagrant/resources/packages/cfengine-nova-hub-3.5.3-1.x86_64.rpm" },
    :ubuntu_hub_enterprise353_deb => { :install_version => "/vagrant/resources/packages/cfengine-nova-hub_3.5.3-1_amd64.deb" },
  }
  ...
  TYPES = {
    "single_centos_hub" => {}
      ...
      .merge(FRAGMENTS[:centos_hub_enterprise353_rpm])
      .merge(TEMPLATES[:hub])
    ...
    "single_ubuntu_hub" => {}
      ...
      .merge(FRAGMENTS[:ubuntu_hub_enterprise353_deb])
      .merge(TEMPLATES[:hub])
      .merge({ :ip => "10.0.0.20", :count => 1 }),
    ...
    "single_centos_eclient" => {}
      .merge(FRAGMENTS[:ipackages])
      .merge(FRAGMENTS[:centos_6_4])
      .merge(FRAGMENTS[:centos_client_enterprise353_rpm])
    ...
    "single_ubuntu_eclient" => {}
      .merge(FRAGMENTS[:ipackages])
      .merge(FRAGMENTS[:ubuntu_13_04])
      .merge(FRAGMENTS[:ubuntu_client_enterprise353_deb])
      .merge(TEMPLATES[:generic])
      .merge({ :ip => "10.0.0.20", :count => 1 }),
